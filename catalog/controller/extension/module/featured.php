			...
			foreach ($products as $product_id) {
				...
				if ($product_info) {
					...
					if ((float)$product_info['discount']) {
    					$discount = $this->currency->format($this->tax->calculate($product_info['discount'], $product_info['tax_class_id'], $this->config->get('config_tax')), $this->session->data['currency']);
    				} else {
    					$discount = false;
    				}
